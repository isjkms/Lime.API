...
namespace Lime.Api.Migrations
{
    ...
    [Migration("20260427081952_AddUserConsents")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lime.Api.Models.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId", "Kind", "ActorId", "RefId")
            ...
            modelBuilder.Entity("Lime.Api.Models.UserConsent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId", "DocKind", "DocVersion")
            ...
            modelBuilder.Entity("Lime.Api.Models.Notification", b =>
                {
                    b.HasOne("Lime.Api.Models.User", "Actor")
                        .WithMany()
